...
namespace Silksprite.AvatarTinkerVista.Ablet.VRChat.Layers
{
    ...
    {
        string IAbletDefinition.Id => "Silksprite.AvatarTinkerVista.OverwriteVRChatViewPosition";
        string IAbletDefinition.DisplayName => "ATiV: Overwrite VRChat View Position";

...
{
    public class BlinkConverterSeparateForVRM0 : AtivOptionConverterBase<AtivOverwriteBlink, BlinkOption, VRMBlendShapeProxy>
    {
        ...
        public override void ToPlatform(AtivOverwriteBlink ativ, VRMBlendShapeProxy platform)
        {
            ...
            switch (options.blinkStyle)
            {
                ...
                case BlinkStyle.None:
                    SetBlendShape(BlendShapePreset.Blink_L, null);
                    SetBlendShape(BlendShapePreset.Blink_R, null);
                    break;
                case BlinkStyle.SingleBlendShape:
                    throw new NotSupportedException();
                case BlinkStyle.SeparateBlendShapes:
                    SetBlendShape(BlendShapePreset.Blink_L, options.separateBlendShapeLeft);
                    SetBlendShape(BlendShapePreset.Blink_R, options.separateBlendShapeRight);
                    break;
                default:
